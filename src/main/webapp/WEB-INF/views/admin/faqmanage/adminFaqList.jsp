		...
		$.ajax({
			...
			success : function(data) {
				...
				for(datas of data) {
					...
					$(tr).addClass("color");
					// tr 클릭 시 페이지 이동
					$(tr).attr("onclick", "location.href='adminFaqRead.do?f_no=" + datas.f_no + "\'");
					...
					btntd.innerHTML = '<button type="button" name="update" id="update" onclick="location.href=\'adminFaqUpdateForm.do?f_no=' + datas.f_no + '\';">수정</button>&nbsp;<button type="button" name="delete" id="delete" onclick="deleteFnc(\'' + datas.f_no + '\')">삭제</button>';
					tr.append(btntd);
 					body.append(tr);
				}
