...
<body>
	 <div class="test">
        <div class="mainForm">
            ...
            <div class="comment">
                <h4>고객님의 본인확인을 진행해주세요.</h4><br>
                <h5>Maeumi. 의 다양한 서비스 이용을 위해 본인확인이 필요합니다.<br> 만 18세 미만의 고객님은 보호자 동의가 필요하니 보호자와 함께 진행해주세요</h5>
            </div>
            <br>
            <div class="emailCheck" style="border: 1px solid gray;">
            	<form id="frm" action="memberJoinForm.do" method="POST">
	                ...
	                <button type="button" id="emailSendBtn" >인증메일 전송</button><br>
                </form>
                <input type="text" placeholder="인증메일 발송을 클릭해주세요." id="checkNum" class="checkNum" readonly="readonly">
