	...
	<form id="frm" action="userBoardUpdate.do" method="post">
		<div class="wrap2" align="center">
			<div class="titleDiv" style="border-bottom: 1px solid black">
				<textarea
					style="text-align: left; margin-left: 20px; border: none; width: 820px;"
					id="b_title" name="b_title">${boardSelect.b_title}</textarea>
				<br> <select id="select2" style="width: 100px" class="subject"
					name="b_subject">
