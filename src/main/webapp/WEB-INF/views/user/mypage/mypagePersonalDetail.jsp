					...
					<div class="card">
						<div class="card-body table-responsive p-00">
							...
							<table class="table text-nowrap" id="infotable">
								<tr>
									<th>신청일시</th>
									<td>${personal.pr_date}</td>
								</tr>
								<tr>
									<th>상태</th>
									<c:if test="${personal.pr_status eq 0 }">
											<td>신청 완료</td>
									</c:if>
									<c:if test="${personal.pr_status eq 1 }">
											<td>상담 완료</td>
									</c:if>
									<c:if test="${personal.pr_status eq 2 }">
											<td>환불 완료</td>
									</c:if>
								</tr>
								<tr>
					...
					<div class="card">
						<div class="card-body table-responsive p-00">
							...
							<table class="table text-nowrap" id="infotable">
								...
								<tr>
									<th>상담주제</th>
									<td>${personal.ccg_subname}</td>
								</tr>
								<tr>
									<th>상담방식</th>
									<td>${personal.pr_type}</td>
								</tr>
								<tr>
									<th>내 용</th>
									<td>${personal.pc_report}</td>
								</tr>
							</table>
							<br>
						</div>
...
<script type="text/javascript">
		function personalDetail(){
			if (confirm("환불 하시겠습니까??") == true) { 
				url = "mypagePersonalDetailRefund.do";
				url = url + "?pr_no="+pr_no;
				location.href = url;
		}
		}
