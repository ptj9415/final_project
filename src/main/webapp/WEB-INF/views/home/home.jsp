    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="resources/user/images/mbtiTest.jpeg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>⏱ 소요시간 약 25분</span>
	    					<h3><a href="project.html">MBTI 검사</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="resources/user/images/work-2.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>⏱ 소요시간 약 25분</span>
	    					<h3>성격검사</h3>
	    				</div>
	    				<a href="resources/user/images/work-2.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="resources/user/images/work-3.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>⏱ 소요시간 약 25분</span>
	    					<h3>자존감 검사</h3>
	    				</div>
	    				<a href="resources/user/images/work-3.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="resources/user/images/work-4.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>⏱ 소요시간 약 25분</span>
	    					<h3>우울증 검사</h3>
	    				</div>
	    				<a href="resources/user/images/work-4.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    				<span>→</span>
