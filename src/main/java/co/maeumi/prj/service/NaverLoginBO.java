...
public class NaverLoginBO {
	 ...
	 * redirect_uri : 네이버 로그인 인증의 결과를 전달받을 콜백 URL(URL인코딩). 애플리케이션을 등록할 때 callback URL에 설정한 정보 
	 * state: 애플리케이션이 생성한 상태 토큰
	 */

	private final static String CLIENT_ID = "SKAYjxZAeWYrFOHQFBGB";
	private final static String CLIENT_SECRET = "rCK6eCZ099";
	private final static String REDIRECT_URI = "http://localhost:8000/prj/callback.do";
